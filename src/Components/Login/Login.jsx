...
const handlesubmit=(e)=>{
    ...
    return (
        <div className="login">
            {/* <lottie-player src="https://assets5.lottiefiles.com/private_files/lf30_mnqdhisx.json" background="transparent"  speed="1"  style={{width: "300px",height:"300px"}} loop  autoplay></lottie-player> */}
        ...
        <div className="logincommon login-heading">
           <h3>Login</h3>
        </div>
       
        <div className="logincommon login-gmail" >
            <input type="email" name="gmail" value={email} required onChange={(e)=>setEmail(e.target.value)} />
            <label htmlFor="">Gmail</label>

        </div>
        <div className="logincommon login-password">
        ...
        <div className="login-alreadyaccount">
